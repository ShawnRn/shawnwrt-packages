(function() {
    ...
    function drawChart() {
        ...
        const maxVal = Math.max(...history.down, ...history.up, 1024 * 50); // Min 50KB/s
    ...
    async function update() {
        try {
            ...
            if (r.wan_ip && r.wan_ip !== '0.0.0.0') {
                ...
                nI.className = 'sw-status offline'; nT.textContent = '确认联通性...';
            }
            ...
            console.error(e);
            document.getElementById('sw-net-status').querySelector('.sw-status-text').textContent = '连接失败: ' + e.message;
        }
    }
